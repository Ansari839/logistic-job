                    ...
                    {loading ? (
                        ...
                        filteredVendors.map((v) => (
                            ...
                            >
                                ...
                                <div className="mb-6">
                                    <h3 className="text-2xl font-black text-slate-900 dark:text-white tracking-tighter mb-1 line-clamp-1">{v.name}</h3>
                                    <p className="text-subtext text-xs font-black uppercase tracking-widest">{v.code}</p>
                                </div>
