            ...
            <div className="mb-10 relative overflow-hidden p-8 rounded-3xl bg-gradient-to-br from-blue-600/20 to-indigo-600/20 border border-blue-500/20 shadow-xl shadow-blue-500/5">
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-subtext max-w-lg leading-relaxed">
                        Your operation at <span className="text-blue-600 dark:text-blue-400 font-bold">{user?.branch || 'Head Office'}</span> is performing <span className="text-emerald-600 dark:text-emerald-400 font-bold">12% better</span> today.
                    </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 glass-panel rounded-3xl overflow-hidden h-fit">
                    <div className="p-8 border-b border-border flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-xs text-subtext mt-1">Real-time status updates from all branches</p>
                        </div>
                        ...
                        {[1, 2, 3].map((i) => (
                            <div key={i} className="flex items-start space-x-6 group">
                                <div className="relative mt-1">
                                    <div className="w-10 h-10 rounded-2xl bg-primary/5 flex items-center justify-center text-emerald-600 dark:text-emerald-400 group-hover:scale-110 transition-transform border border-border">
                                        <CheckCircle size={18} />
                                    </div>
                                ...
                                <div className="flex-1">
                                    <div className="flex justify-between items-start">
                                        <p className="text-sm text-slate-900 dark:text-white font-bold">Shipment #LGS-990{i} Delivered</p>
                                        <span className="text-[10px] text-subtext font-mono">1{i}m ago</span>
                                    </div>
                                    <p className="text-xs text-subtext mt-1 tracking-wide uppercase font-bold">Head Office • Final Destination</p>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <div className="glass-panel rounded-3xl overflow-hidden">
                    <div className="p-8 border-b border-border">
                        <h3 className="text-xl font-bold text-slate-900 dark:text-white">Monthly Target</h3>
                    </div>
                    <div className="p-8 text-center">
                        <div className="relative inline-flex items-center justify-center p-10 mb-6">
                            <svg className="w-40 h-40 transform -rotate-90">
                                ...
                                <circle className="text-blue-600 dark:text-blue-500" strokeWidth="12" strokeDasharray={440} strokeDashoffset={440 * (1 - 0.85)} strokeLinecap="round" stroke="currentColor" fill="transparent" r="70" cx="80" cy="80" />
                            </svg>
